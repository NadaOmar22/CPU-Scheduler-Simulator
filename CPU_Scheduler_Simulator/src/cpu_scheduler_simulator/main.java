package cpu_scheduler_simulator;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                System.out.println(
                        "Enter processes numbers and information(name, priority, arrival time, burst time)\n(ex->p1 5 10 20)");
                ...
                System.out.println(
                        "Enter processName, its color, its arrivalTime and its burstTime seprated with spaces");
                if (choice == 2) {
                    for (int i = 0; i < noProc; i++) {
                ...
                int arg;
                agat.noProc = noProc;
                System.out.println("Enter process Name, its color, burst time, arrival time, priority num, quantum time seprated with spaces");
